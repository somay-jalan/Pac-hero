...
public class Main extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        BgmMusic bgm_runnable= BgmMusic.getInstance(); //creating runnable for bgm uing singelton pattern
        Thread bgm=new Thread(bgm_runnable);
        bgm.run();
